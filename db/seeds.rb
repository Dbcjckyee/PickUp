...
@user = User.new(email: "wellington@wellington.com", password: "password", first_name: "wellington", last_name: "wellington")
User.create(email: "robin@robin.com", password: "password", first_name: "robin", last_name: "robin")
@user = User.create(email: "justin@justin.com", password: "password", first_name: "justin", last_name: "justin")
@user = User.create(email: "wei@wei.com", password: "password", first_name: "wei", last_name: "wei")
